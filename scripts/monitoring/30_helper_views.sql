...
WHERE POLICY_KIND = 'MASKING_POLICY'
    AND POLICY_DB = 'DITTEAU_DATA_GOVERNANCE'
...
WHERE TAG_DATABASE = 'DITTEAU_DATA_GOVERNANCE'
...
FROM DITTEAU_DATA_PROD.INFORMATION_SCHEMA.COLUMNS c
...
WHERE DATABASE_NAME IN ('DITTEAU_DATA_DEV', 'DITTEAU_DATA_TEST', 'DITTEAU_DATA_PROD')
...
WITH table_queries AS (
    ...
    WHERE qh.DATABASE_NAME = 'DITTEAU_DATA_GOVERNANCE'
...
WITH all_tables AS (
    ...
    FROM DITTEAU_DATA_PROD.INFORMATION_SCHEMA.COLUMNS
...
GRANT SELECT ON ALL VIEWS IN SCHEMA DITTEAU_DATA_GOVERNANCE.GOVERNANCE TO ROLE DATA_ENGINEER_ROLE;
GRANT SELECT ON ALL VIEWS IN SCHEMA DITTEAU_DATA_GOVERNANCE.GOVERNANCE TO ROLE IR_ANALYST_ROLE;

-- Future views
GRANT SELECT ON FUTURE VIEWS IN SCHEMA DITTEAU_DATA_GOVERNANCE.GOVERNANCE TO ROLE DATA_ENGINEER_ROLE;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA DITTEAU_DATA_GOVERNANCE.GOVERNANCE TO ROLE IR_ANALYST_ROLE;
