...
USE WAREHOUSE GOVERNANCE_PROD;  -- Or GOVERNANCE_DEV, GOVERNANCE_TEST
...
WITH all_tables AS (
    ...
    FROM DITTEAU_DATA_PROD.INFORMATION_SCHEMA.TABLES
...
tagged_tables AS (
    ...
    LEFT JOIN SNOWFLAKE.ACCOUNT_USAGE.TAG_REFERENCES tr
        ...
        AND tr.TAG_DATABASE = 'DITTEAU_DATA_GOVERNANCE'
