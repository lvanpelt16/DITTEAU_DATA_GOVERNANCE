...
-- Apply to student dimension table
ALTER TABLE DITTEAU_DATA.DISTRIBUTE.DIM_STUDENT
    MODIFY COLUMN SSN SET MASKING POLICY DITTEAU_DATA.GOVERNANCE.SSN_MASK;

ALTER TABLE DITTEAU_DATA.DISTRIBUTE.DIM_STUDENT
    MODIFY COLUMN EMAIL SET MASKING POLICY DITTEAU_DATA.GOVERNANCE.EMAIL_MASK;

ALTER TABLE DITTEAU_DATA.DISTRIBUTE.DIM_STUDENT
    MODIFY COLUMN BIRTH_DATE SET MASKING POLICY DITTEAU_DATA.GOVERNANCE.DOB_MASK;

ALTER TABLE DITTEAU_DATA.DISTRIBUTE.DIM_STUDENT
    MODIFY COLUMN PHONE_NUMBER SET MASKING POLICY DITTEAU_DATA.GOVERNANCE.PHONE_MASK;

ALTER TABLE DITTEAU_DATA.DISTRIBUTE.DIM_STUDENT
    MODIFY COLUMN HOME_ADDRESS SET MASKING POLICY DITTEAU_DATA.GOVERNANCE.ADDRESS_MASK;

-- Apply to financial aid fact table
ALTER TABLE DITTEAU_DATA.DISTRIBUTE.FACT_FINANCIAL_AID
    MODIFY COLUMN AID_AMOUNT SET MASKING POLICY DITTEAU_DATA.GOVERNANCE.FINANCIAL_AMOUNT_MASK;

ALTER TABLE DITTEAU_DATA.DISTRIBUTE.FACT_FINANCIAL_AID
    MODIFY COLUMN EFC_AMOUNT SET MASKING POLICY DITTEAU_DATA.GOVERNANCE.FINANCIAL_AMOUNT_MASK;
*/
