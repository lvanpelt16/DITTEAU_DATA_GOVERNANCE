...
DESCRIBE TAG DITTEAU_DATA.GOVERNANCE.SENSITIVITY_LEVEL;
DESCRIBE TAG DITTEAU_DATA.GOVERNANCE.COMPLIANCE_TYPE;
DESCRIBE TAG DITTEAU_DATA.GOVERNANCE.CONTAINS_PII;
DESCRIBE TAG DITTEAU_DATA.GOVERNANCE.DATA_DOMAIN;
DESCRIBE TAG DITTEAU_DATA.GOVERNANCE.DATA_OWNER;
DESCRIBE TAG DITTEAU_DATA.GOVERNANCE.RETENTION_PERIOD;
DESCRIBE TAG DITTEAU_DATA.GOVERNANCE.DATA_QUALITY_TIER;
...
-- Example 1: Tag a student demographics table
ALTER TABLE DITTEAU_DATA.DISTRIBUTE.DIM_STUDENT
    SET TAG DITTEAU_DATA.GOVERNANCE.SENSITIVITY_LEVEL = 'RESTRICTED',
            DITTEAU_DATA.GOVERNANCE.COMPLIANCE_TYPE = 'FERPA',
            DITTEAU_DATA.GOVERNANCE.DATA_DOMAIN = 'ACADEMIC',
            DITTEAU_DATA.GOVERNANCE.DATA_OWNER = 'REGISTRAR';
...
ALTER TABLE DITTEAU_DATA.DISTRIBUTE.DIM_STUDENT
    ...
    SET TAG DITTEAU_DATA.GOVERNANCE.SENSITIVITY_LEVEL = 'RESTRICTED',
            DITTEAU_DATA.GOVERNANCE.COMPLIANCE_TYPE = 'FERPA',
            DITTEAU_DATA.GOVERNANCE.CONTAINS_PII = 'TRUE';

-- Example 3: Tag an email column
ALTER TABLE DITTEAU_DATA.DISTRIBUTE.DIM_STUDENT
    MODIFY COLUMN EMAIL
    SET TAG DITTEAU_DATA.GOVERNANCE.SENSITIVITY_LEVEL = 'CONFIDENTIAL',
            DITTEAU_DATA.GOVERNANCE.CONTAINS_PII = 'TRUE';

-- Example 4: Tag a financial aid table
ALTER TABLE DITTEAU_DATA.DISTRIBUTE.FACT_FINANCIAL_AID
    SET TAG DITTEAU_DATA.GOVERNANCE.SENSITIVITY_LEVEL = 'RESTRICTED',
            DITTEAU_DATA.GOVERNANCE.COMPLIANCE_TYPE = 'FERPA',
            DITTEAU_DATA.GOVERNANCE.DATA_DOMAIN = 'FINANCIAL_AID',
            DITTEAU_DATA.GOVERNANCE.DATA_OWNER = 'FINANCIAL_AID',
            DITTEAU_DATA.GOVERNANCE.RETENTION_PERIOD = '7_YEARS';

-- Example 5: Tag staging/intermediate models
ALTER TABLE DITTEAU_DATA.DETERGE.INT_STUDENTS
    SET TAG DITTEAU_DATA.GOVERNANCE.DATA_QUALITY_TIER = 'SILVER',
            DITTEAU_DATA.GOVERNANCE.SENSITIVITY_LEVEL = 'RESTRICTED';
*/
...
SELECT * FROM DITTEAU_DATA.GOVERNANCE.V_TAGGED_OBJECTS 
