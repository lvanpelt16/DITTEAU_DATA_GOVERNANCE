...
-- Apply enrollment status filtering to student dimension (all environments)
-- PROD
ALTER TABLE DITTEAU_DATA_PROD.DISTRIBUTE.DIM_STUDENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.ENROLLMENT_ROW_ACCESS
    ON (ENROLLMENT_STATUS);
ALTER TABLE DITTEAU_DATA_PROD.DISTRIBUTE.DIM_STUDENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.ACTIVE_RECORDS_ONLY
    ON (IS_ACTIVE);
ALTER TABLE DITTEAU_DATA_PROD.DISTRIBUTE.DIM_STUDENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_AY_ACCESS
...
-- Apply to enrollment fact table (all environments)
-- PROD
ALTER TABLE DITTEAU_DATA_PROD.DISTRIBUTE.FACT_ENROLLMENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_AY_ACCESS
    ON (ACADEMIC_YEAR);
ALTER TABLE DITTEAU_DATA_PROD.DISTRIBUTE.FACT_ENROLLMENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_TERM_ACCESS
    ON (TERM_CODE);

-- TEST
ALTER TABLE DITTEAU_DATA_TEST.DISTRIBUTE.FACT_ENROLLMENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_AY_ACCESS
    ON (ACADEMIC_YEAR);
ALTER TABLE DITTEAU_DATA_TEST.DISTRIBUTE.FACT_ENROLLMENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_TERM_ACCESS
...
-- DEV
ALTER TABLE DITTEAU_DATA_DEV.DISTRIBUTE.FACT_ENROLLMENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_AY_ACCESS
    ON (ACADEMIC_YEAR);
ALTER TABLE DITTEAU_DATA_DEV.DISTRIBUTE.FACT_ENROLLMENT
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_TERM_ACCESS
...
-- Apply to course registrations (all environments)
ALTER TABLE DITTEAU_DATA_PROD.DETERGE.INT_COURSE_REGISTRATIONS
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_TERM_ACCESS
    ON (TERM_CODE);
ALTER TABLE DITTEAU_DATA_TEST.DETERGE.INT_COURSE_REGISTRATIONS
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_TERM_ACCESS
    ON (TERM_CODE);
ALTER TABLE DITTEAU_DATA_DEV.DETERGE.INT_COURSE_REGISTRATIONS
    ADD ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.CURRENT_TERM_ACCESS
    ON (TERM_CODE);
*/
...
DROP ROW ACCESS POLICY DITTEAU_DATA_GOVERNANCE.GOVERNANCE.ENROLLMENT_ROW_ACCESS;
*/
